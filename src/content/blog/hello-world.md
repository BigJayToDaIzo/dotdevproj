---
title: "Hello, World"
description: "First post on the new site. Testing out the terminal aesthetic."
pubDate: 2026-01-16
tags: ["meta", "web-dev"]
---
...
This site is built with [Astro](https://astro.build), which has been a pleasure to work with. Static site generation, content collections for the blog, and zero JavaScript shipped to the client by default (unless I specifically opt in).
